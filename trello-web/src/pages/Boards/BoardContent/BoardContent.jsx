...
function BoardContent({ Board,
  ...
  const handleDragOver = (event) => {
    ...
    if (activeColumn._id !== overColumn._id) {
      moveCardBeetweenDifferentColumns(overColumn, overCardId, activeColumn, activeDraggingCardId, activeDraggingCardData, over, active, 'handleDragOver')
    }
  ...
  const handleDragEnd = (event) => {
    ...
    if (activeDragItemType === ACTIVE_DRAG_ITEM_TYPE.CARD) {
      ...
      if (oldColumnWhenDraggingCard._id !== overColumn._id) {
        moveCardBeetweenDifferentColumns(overColumn, overCardId, activeColumn, activeDraggingCardId, activeDraggingCardData, over, active, 'handleDragEnd')
      } else {
